...
//MISCELLANEOUS
    ...
    //SNOW & POWDERED SNOW
    public static final Item SNOWY_TYPE_BLOCK = register("snowy_type_block", new BlockItem(JinericBlocks.SNOWY_TYPE_BLOCK, JinericItemSettings.Decoration().group(JinericItemGroups.JINERIC_BLOCKS)));
