...
//MISCELLANEOUS
    ...
    //SNOW & POWDERED SNOW
    public static final Block SNOWY_TYPE_BLOCK = register("snowy_type_block", new Block(FabricBlockSettings.copy(JinericBlockSettings.JinericSnowWallSettings())));
    public static final Block SNOW_WALL = register("snow_wall", new BaseJinericSnowWall(FabricBlockSettings.copy(SNOWY_TYPE_BLOCK)));
    //DECORATION BLOCKS
