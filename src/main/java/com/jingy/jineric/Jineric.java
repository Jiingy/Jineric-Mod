...
public class Jineric implements ModInitializer {
    ...
    public static ConfiguredFeature<?, ?> BORITE_VEIN = Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, Blocks.BORITE.getDefaultState(), 33)).rangeOf(80).spreadHorizontally().repeat(10);
