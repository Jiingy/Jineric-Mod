...
public class JinericTextureRenderLayers extends TexturedRenderLayers {
   ...
   public static final SpriteIdentifier TRAPPED_ACACIA_CHEST_LEFT = createChestTextureId("trapped_acacia_chest_left");
   public static final SpriteIdentifier TRAPPED_ACACIA_CHEST_RIGHT = createChestTextureId("trapped_acacia_chest_right");
   ...
   public static final SpriteIdentifier TRAPPED_BIRCH_CHEST_LEFT = createChestTextureId("trapped_birch_chest_left");
   public static final SpriteIdentifier TRAPPED_BIRCH_CHEST_RIGHT = createChestTextureId("trapped_birch_chest_right");
   public static final SpriteIdentifier TRAPPED_CRIMSON_CHEST = createChestTextureId("trapped_crimson_chest");
   public static final SpriteIdentifier TRAPPED_CRIMSON_CHEST_LEFT = createChestTextureId("trapped_crimson_chest_left");
   public static final SpriteIdentifier TRAPPED_CRIMSON_CHEST_RIGHT = createChestTextureId("trapped_crimson_chest_right");
   public static final SpriteIdentifier TRAPPED_DARK_OAK_CHEST = createChestTextureId("trapped_dark_oak_chest");
   public static final SpriteIdentifier TRAPPED_DARK_OAK_CHEST_LEFT = createChestTextureId("trapped_dark_oak_chest_left");
   public static final SpriteIdentifier TRAPPED_DARK_OAK_CHEST_RIGHT = createChestTextureId("trapped_dark_oak_chest_right");
   public static final SpriteIdentifier TRAPPED_JUNGLE_CHEST = createChestTextureId("trapped_jungle_chest");
   public static final SpriteIdentifier TRAPPED_JUNGLE_CHEST_LEFT = createChestTextureId("trapped_jungle_chest_left");
   public static final SpriteIdentifier TRAPPED_JUNGLE_CHEST_RIGHT = createChestTextureId("trapped_jungle_chest_right");
   public static final SpriteIdentifier TRAPPED_SPRUCE_CHEST = createChestTextureId("trapped_spruce_chest");
   public static final SpriteIdentifier TRAPPED_SPRUCE_CHEST_LEFT = createChestTextureId("trapped_spruce_chest_left");
   public static final SpriteIdentifier TRAPPED_SPRUCE_CHEST_RIGHT = createChestTextureId("trapped_spruce_chest_right");
   public static final SpriteIdentifier TRAPPED_WARPED_CHEST = createChestTextureId("trapped_warped_chest");
   public static final SpriteIdentifier TRAPPED_WARPED_CHEST_LEFT = createChestTextureId("trapped_warped_chest_left");
   public static final SpriteIdentifier TRAPPED_WARPED_CHEST_RIGHT = createChestTextureId("trapped_warped_chest_right");
   public static final SpriteIdentifier TRAPPED_MANGROVE_CHEST = createChestTextureId("trapped_mangrove_chest");
   public static final SpriteIdentifier TRAPPED_MANGROVE_CHEST_LEFT = createChestTextureId("trapped_mangrove_chest_left");
   public static final SpriteIdentifier TRAPPED_MANGROVE_CHEST_RIGHT = createChestTextureId("trapped_mangrove_chest_right");
   public static final SpriteIdentifier TRAPPED_CHERRY_CHEST = createChestTextureId("trapped_cherry_chest");
   public static final SpriteIdentifier TRAPPED_CHERRY_CHEST_LEFT = createChestTextureId("trapped_cherry_chest_left");
   public static final SpriteIdentifier TRAPPED_CHERRY_CHEST_RIGHT = createChestTextureId("trapped_cherry_chest_right");
   public static final SpriteIdentifier TRAPPED_BAMBOO_CHEST = createChestTextureId("trapped_bamboo_chest");
   public static final SpriteIdentifier TRAPPED_BAMBOO_CHEST_LEFT = createChestTextureId("trapped_bamboo_chest_left");
   public static final SpriteIdentifier TRAPPED_BAMBOO_CHEST_RIGHT = createChestTextureId("trapped_bamboo_chest_right");
