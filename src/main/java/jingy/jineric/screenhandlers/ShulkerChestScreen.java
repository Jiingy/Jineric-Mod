...
public class ShulkerChestScreen extends HandledScreen<ShulkerChestScreenHandler> {
    private static final Identifier SHULKER_CHEST_GUI = new Identifier(Jineric.MOD_ID, "textures/gui/container/generic_54.png");
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        assert client != null;
        client.getTextureManager().bindTexture(SHULKER_CHEST_GUI);
