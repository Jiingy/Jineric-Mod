...
//BUILDING BLOCKS
	...
	public static final Item SLATE = register("slate", new BlockItem(JinericBlocks.SLATE, JinericItemSettings.Decoration().group(JinericItemGroups.BUILDING_BLOCKS)));
	public static final Item SLATE_STAIRS = register("slate_stairs", new BlockItem(JinericBlocks.SLATE_STAIRS, JinericItemSettings.Decoration().group(JinericItemGroups.BUILDING_BLOCKS)));
	public static final Item SLATE_SLAB = register("slate_slab", new BlockItem(JinericBlocks.SLATE_SLAB, JinericItemSettings.Decoration().group(JinericItemGroups.BUILDING_BLOCKS)));
	...
	public static final Item OBSIDIAN_SLAB = register("obsidian_slab", new BlockItem(JinericBlocks.OBSIDIAN_SLAB, JinericItemSettings.Decoration().group(JinericItemGroups.BUILDING_BLOCKS)));
	...
	public static final Item PACKED_ICE_STAIRS = register("packed_ice_stairs", new BlockItem(JinericBlocks.PACKED_ICE_STAIRS, JinericItemSettings.Decoration().group(JinericItemGroups.BUILDING_BLOCKS)));
	public static final Item PACKED_ICE_SLAB = register("packed_ice_slab", new BlockItem(JinericBlocks.PACKED_ICE_SLAB, JinericItemSettings.Decoration().group(JinericItemGroups.BUILDING_BLOCKS)));
	...
	public static final Item SILTSTONE_WALL = register("siltstone_wall", new BlockItem(JinericBlocks.SILTSTONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item POLISHED_SILTSTONE_WALL = register("polished_siltstone_wall", new BlockItem(JinericBlocks.POLISHED_SILTSTONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item SLATE_WALL = register("slate_wall", new BlockItem(JinericBlocks.SLATE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item BORITE_WALL = register("borite_wall", new BlockItem(JinericBlocks.BORITE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item SOUL_SANDSTONE_WALL = register("soul_sandstone_wall", new BlockItem(JinericBlocks.SOUL_SANDSTONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item CUT_SOUL_SANDSTONE_WALL = register("cut_soul_sandstone_wall", new BlockItem(JinericBlocks.CUT_SOUL_SANDSTONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item POLISHED_SOUL_SANDSTONE_WALL = register("polished_soul_sandstone_wall", new BlockItem(JinericBlocks.POLISHED_SOUL_SANDSTONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item WAVY_SOUL_SANDSTONE_WALL = register("wavy_soul_sandstone_wall", new BlockItem(JinericBlocks.WAVY_SOUL_SANDSTONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item SMOOTH_SOUL_SANDSTONE_WALL = register("smooth_soul_sandstone_wall", new BlockItem(JinericBlocks.SMOOTH_SOUL_SANDSTONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item CHISELED_SOUL_SANDSTONE_WALL = register("chiseled_soul_sandstone_wall", new BlockItem(JinericBlocks.CHISELED_SOUL_SANDSTONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item CUT_SANDSTONE_WALL = register("cut_sandstone_wall", new BlockItem(JinericBlocks.CUT_SANDSTONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item POLISHED_SANDSTONE_WALL = register("polished_sandstone_wall", new BlockItem(JinericBlocks.POLISHED_SANDSTONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item WAVY_SANDSTONE_WALL = register("wavy_sandstone_wall", new BlockItem(JinericBlocks.WAVY_SANDSTONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item SMOOTH_SANDSTONE_WALL = register("smooth_sandstone_wall", new BlockItem(JinericBlocks.SMOOTH_SANDSTONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item CHISELED_SANDSTONE_WALL = register("chiseled_sandstone_wall", new BlockItem(JinericBlocks.CHISELED_SANDSTONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	...
	public static final Item POLISHED_RED_SANDSTONE_WALL = register("polished_red_sandstone_wall", new BlockItem(JinericBlocks.POLISHED_RED_SANDSTONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item WAVY_RED_SANDSTONE_WALL = register("wavy_red_sandstone_wall", new BlockItem(JinericBlocks.WAVY_RED_SANDSTONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	...
	public static final Item CHISELED_RED_SANDSTONE_WALL = register("chiseled_red_sandstone_wall", new BlockItem(JinericBlocks.CHISELED_RED_SANDSTONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item STONE_WALL = register("stone_wall", new BlockItem(JinericBlocks.STONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item CRACKED_STONE_BRICK_WALL = register("cracked_stone_brick_wall", new BlockItem(JinericBlocks.CRACKED_STONE_BRICK_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item SMOOTH_STONE_WALL = register("smooth_stone_wall", new BlockItem(JinericBlocks.SMOOTH_STONE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item POLISHED_GRANITE_WALL = register("polished_granite_wall", new BlockItem(JinericBlocks.POLISHED_GRANITE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item POLISHED_DIORITE_WALL = register("polished_diorite_wall", new BlockItem(JinericBlocks.POLISHED_DIORITE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item POLISHED_ANDESITE_WALL = register("polished_andesite_wall", new BlockItem(JinericBlocks.POLISHED_ANDESITE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item OBSIDIAN_WALL = register("obsidian_wall", new BlockItem(JinericBlocks.OBSIDIAN_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item PACKED_ICE_WALL = register("packed_ice_wall", new BlockItem(JinericBlocks.PACKED_ICE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item SNOW_WALL = register("snow_wall", new BlockItem(JinericBlocks.SNOW_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item DARK_PRISMARINE_WALL = register("dark_prismarine_wall", new BlockItem(JinericBlocks.DARK_PRISMARINE_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
	public static final Item PRISMARINE_BRICK_WALL = register("prismarine_brick_wall", new BlockItem(JinericBlocks.PRISMARINE_BRICK_WALL, JinericItemSettings.Decoration().group(JinericItemGroups.DECORATION_BLOCKS)));
