...
public class JmCreativeModeTabs {
	...
	public static final CreativeModeTab CONTENT = CreativeModeTab.builder(CreativeModeTab.Row.TOP, 1)
			...
			.displayItems((context, entries) -> {
				...
				entries.accept(JinericItems.CUT_COPPER_WALL.unaffected());
				entries.accept(JinericItems.CUT_COPPER_WALL.exposed());
				entries.accept(JinericItems.CUT_COPPER_WALL.weathered());
				entries.accept(JinericItems.CUT_COPPER_WALL.oxidized());
				entries.accept(JinericItems.CUT_COPPER_WALL.waxed());
				entries.accept(JinericItems.CUT_COPPER_WALL.waxedExposed());
				entries.accept(JinericItems.CUT_COPPER_WALL.waxedWeathered());
				entries.accept(JinericItems.CUT_COPPER_WALL.waxedOxidized());
	...
	public static void modifyVanillaGroups() {
		CreativeModeTabEvents.modifyOutputEvent(CreativeModeTabs.BUILDING_BLOCKS).register((entries) -> {
			...
			entries.insertAfter(Items.CUT_COPPER_SLAB, JinericItems.CUT_COPPER_WALL.unaffected());
			entries.insertAfter(Items.EXPOSED_CUT_COPPER, JinericItems.CUT_COPPER_WALL.exposed());
			entries.insertAfter(Items.WEATHERED_CUT_COPPER_SLAB, JinericItems.CUT_COPPER_WALL.weathered());
			entries.insertAfter(Items.OXIDIZED_CUT_COPPER_SLAB, JinericItems.CUT_COPPER_WALL.oxidized());
			entries.insertAfter(Items.WAXED_CUT_COPPER_SLAB, JinericItems.CUT_COPPER_WALL.waxed());
			entries.insertAfter(Items.WAXED_EXPOSED_CUT_COPPER, JinericItems.CUT_COPPER_WALL.waxedExposed());
			entries.insertAfter(Items.WAXED_WEATHERED_CUT_COPPER_SLAB, JinericItems.CUT_COPPER_WALL.waxedWeathered());
			entries.insertAfter(Items.WAXED_OXIDIZED_CUT_COPPER_SLAB, JinericItems.CUT_COPPER_WALL.waxedOxidized());
