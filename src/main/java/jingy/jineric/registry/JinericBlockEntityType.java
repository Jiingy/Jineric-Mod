...
public class JinericBlockEntityType {
	...
	public static final BlockEntityType<JinericSignBlockEntity> JINERIC_SIGN = FabricBlockEntityTypeBuilder.create(
			JinericSignBlockEntity::new,
			JinericBlocks.PETRIFIED_OAK_SIGN,
			JinericBlocks.PETRIFIED_OAK_WALL_SIGN
	).build();
	
	public static final BlockEntityType<JinericHangingSignBlockEntity> JINERIC_HANGING_SIGN = FabricBlockEntityTypeBuilder.create(
	...
	public static void registerBlockEntityTypes() {
		...
		register("jineric_sign", JINERIC_SIGN);
		register("jineric_hanging_sign", JINERIC_HANGING_SIGN);
