...
public class JinericRecipeProviders extends RecipeGenerator {
   //TODO: THIS IS ALL BROKEN 1.21.3
   protected JinericRecipeProviders(RegistryWrapper.WrapperLookup registries, RecipeExporter exporter) {
...
//      //TODO: MAYBE THIS SHIT IS STUPID IDK ILL SEE IF IT WORKS 1.21.3
...
//              .criterion(RecipeGenerator.hasItem(itemInput), conditionsFromItem(itemInput))
