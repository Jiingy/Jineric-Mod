...
public class KilnScreen extends AbstractFurnaceScreen<KilnScreenHandler> implements JmAbstractRecipeBookScreen {
	...
	private static final List<RecipeBookComponent.TabInfo> TABS = List.of(
			...
			new RecipeBookComponent.TabInfo(Items.TERRACOTTA, JinericRecipeBookCategories.KILN_BLOCKS),
			new RecipeBookComponent.TabInfo(Items.SPONGE, JinericRecipeBookCategories.KILN_MISC)
	);
